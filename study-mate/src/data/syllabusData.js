...
export const getSubjects = (examType = 'JEE') => Object.keys(syllabus[examType] || syllabus.JEE)
export const getChapters = (examType = 'JEE', subject) => (syllabus[examType] || syllabus.JEE)[subject] || []
export const getChapterMeta = (subject, chapter) => chapterMeta[subject]?.[chapter] || { weight: 3, prerequisites: [], concepts: [chapter || subject], strategy: `Build concept clarity and solve PYQs from ${chapter || subject}.` }

export const getSyllabus = (examType) => examType ? syllabus[examType] : syllabus
